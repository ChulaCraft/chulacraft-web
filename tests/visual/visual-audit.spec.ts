...
const routes = [
  ...
  { name: "register-unauthenticated", path: "/register", expectedPath: "/", expectedStatus: 200, authenticated: false },
  { name: "register", path: "/register", expectedPath: "/register", expectedStatus: 200, authenticated: true },
